...
const { MongoClient } = require('mongodb'); // Correctly importing MongoClient
...
if (!clientPromise) {
  client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true }); // Proper initialization
...
export default async function handler(req, res) {
  try {
    ...
    const db = client.db('SkinList'); // Replace with your database name
